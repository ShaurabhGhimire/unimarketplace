  ...
  return (
    <SafeAreaView style={styles.safe}>
      <View style={styles.card}>
        <Text style={styles.title}>Verify Your .edu Email</Text>
        <Text style={styles.subtitle}>Sign up with your college email to continue</Text>
        ...
        <View style={styles.row}>
          ...
          <Pressable style={styles.nextBtn} onPress={handleSendCode}>
            <Text style={styles.nextText}>{loading ? 'Sending...' : 'Send Verification Code'}</Text>
          </Pressable>
        </View>
      </View>
    </SafeAreaView>
